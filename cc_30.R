...
expo_dir   <- file.path(base_dir, "wf_bi3")
...
fwrite(final_pooled, 
       file.path(out_dir, "Pooled_Statewide_RR_PAN_2015_2024_30.csv"), 
       bom = TRUE)

cat("\nSaved to:", file.path(out_dir, "Pooled_Statewide_RR_PAN_2015_2024_30.csv"), "\n")