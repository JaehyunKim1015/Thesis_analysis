...
expo_dir   <- file.path(base_dir, "wf_bi2")
...
fwrite(final_pooled, 
       file.path(out_dir, "Pooled_Statewide_RR_PAN_2015_2024_20.csv"), 
       bom = TRUE)

cat("\nSaved to:", file.path(out_dir, "Pooled_Statewide_RR_PAN_2015_2024_20.csv"), "\n")